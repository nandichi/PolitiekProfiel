...
| Tier | Stellingen | Tijd | Beschrijving |
| --- | --- | --- | --- |
| Quick | 30 | ~5 min | Korte indicatie van waar je staat. |
| Standard (aanbevolen) | 50 | ~10 min | Onze aanbevolen lengte voor een degelijk profiel. |
| Extended | 80 | ~20 min | Diepgaande analyse met de meeste nuances. |

Begin op `https://politiekprofiel.nl/quiz/quick`, `/quiz/standard` of `/quiz/extended`.
