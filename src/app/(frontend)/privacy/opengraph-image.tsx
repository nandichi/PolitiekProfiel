  ...
  return new ImageResponse(
    (
      <OgTemplate
        ...
        body="Politieke voorkeur valt onder bijzondere persoonsgegevens (AVG). We slaan alleen anoniem je vijf dimensiescores op — geen IP, geen user-agent, geen individuele antwoorden."
        meta={[
